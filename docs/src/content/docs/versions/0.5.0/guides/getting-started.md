---
slug: versions/0.5.0/guides/getting-started
title: Getting started with 0.5.0
description: Install and launch Riptide 0.5.0.
---
...
```bash
pesde add riptide/core@0.5.0 --alias Riptide
pesde install
```
...
Alternatively, download `Riptide.rbxm` from the [v0.5.0 release](https://github.com/riptide-project/framework/releases/tag/v0.5.0) and insert it as `ReplicatedStorage/Packages/Riptide` in Studio.
...
This page describes **Riptide 0.5.0**. Check the [original release guide](../../readme/) and [tagged source](https://github.com/riptide-project/framework/tree/v0.5.0) for release-specific details.
