---
slug: versions/0.7.0/api/state-replication
title: State replication
description: Server-authoritative state in Riptide 0.7.0.
---
...
0.7.0 introduced this API. Version 0.7.1 later fixed scoped delta tracking and the fallback from a removed player override to a global value.
