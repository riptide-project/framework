---
slug: versions/0.7.1/guides/getting-started
title: Getting started with 0.7.1
description: Install and launch Riptide 0.7.1.
---
...
```bash
pesde add riptide/core@0.7.1 --alias Riptide
pesde install
```
...
Alternatively, download `Riptide.rbxm` from the [v0.7.1 release](https://github.com/riptide-project/framework/releases/tag/v0.7.1) and insert it as `ReplicatedStorage/Packages/Riptide` in Studio.
