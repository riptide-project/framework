---
slug: versions/0.9.0-maelstrom.3/api/state-machine
title: State Machine
...
Its listeners follow Maelstrom-3 Signal semantics: they are scheduled independently and may finish after the transition method returns.
