---
slug: versions/0.9.0-maelstrom.3/api/player-lifecycle
...
Each player's initialization runs independently. A yielding hook for one player does not delay the hooks for another player.
