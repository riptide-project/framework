---
slug: versions/0.4.0/readme
title: Historical 0.4.0 guide
description: The 0.4.0 release guide, adapted from its README.
---

:::caution[Historical documentation]
This guide is adapted from the v0.4.0 source. Its APIs and install commands apply to that release.
:::
...
### Manual
Download `Riptide.rbxm` from the [v0.4.0 release](https://github.com/riptide-project/framework/releases/tag/v0.4.0) and insert it as `ReplicatedStorage/Packages/Riptide`.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/riptide-project/framework/blob/v0.4.0/LICENSE) file for details.
