---
slug: versions/0.6.0/guides/getting-started
title: Getting started with 0.6.0
description: Install and launch Riptide 0.6.0.
---
...
```bash
pesde add riptide/core@0.6.0 --alias Riptide
pesde install
```
...
Alternatively, download `Riptide.rbxm` from the [v0.6.0 release](https://github.com/riptide-project/framework/releases/tag/v0.6.0) and insert it as `ReplicatedStorage/Packages/Riptide` in Studio.
