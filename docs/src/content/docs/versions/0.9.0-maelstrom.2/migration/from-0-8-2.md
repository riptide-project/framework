---
slug: versions/0.9.0-maelstrom.2/migration/from-0-8-2
title: From 0.8.2 Stable
description: Migration checklist for moving from the 0.8.2 stable release to 0.9.0-maelstrom.2.
---

Maelstrom-2 is a preview release. It includes breaking changes that improve type quality, plugin extensibility, network safety, and runtime determinism.
