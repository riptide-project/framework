---
slug: versions/0.9.0-maelstrom.2/api/network
title: Network
...
For request/response patterns, use a pair of events. Register the response handler before sending the request. `Network.Register` does not return a response:
